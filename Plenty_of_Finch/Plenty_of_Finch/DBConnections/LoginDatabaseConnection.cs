...
namespace Plenty_of_Finch.DBConnections
{
    public class Databasestuff
    {
            ...
            {   
                ...
                string connectionString = "server=server=cis-mssql1.temple.edu;Database=sp26_3342_tus45674;  User id = tup20353; Password = Hebee9jeed; Encrypt=True;TrustServerCertificate=True";
